...
class CheckerSuite(unittest.TestCase):
	...
	def test_4_redeclared(self):
		...
		expect = str(Redeclared(Function(),"p"))
	...
	def test_7_undeclared(self):
		...
		expect = str(Undeclared(Procedure(),"f"))
	...
	def test_12_funcdecl(self):
		...
		expect = str(Redeclared(Function(),"y"))
	...
	def test_13_funcdecl(self):
		...
		expect = str(TypeMismatchInExpression(CallExpr(Id("y"),[IntLiteral(1),IntLiteral(2)])))
	...
	def test_16_block_scope(self):
		...
		y:=100; end"""
		expect = str(TypeMismatchInStatement(Assign(Id("y"),IntLiteral(100))))
	...
	def test_17_block_scope(self):
		...
		begin x:=1;y:=2;z[1]:=3; end
		x:=100; end"""
		expect = str(TypeMismatchInStatement(Assign(Id("x"),IntLiteral(100))))
	...
	def test_37_for(self):
		...
		procedure main(); var x:integer; begin x:=foo(); foo(); end"""
		expect = str(TypeMismatchInStatement(For(Id("a"),IntLiteral(1),IntLiteral(2),True,[With([VarDecl(Id("a"),IntType()),VarDecl(Id("b"),BoolType())],[Assign(Id("b"),BooleanLiteral(True)),Break()])])))
	...
	def test_39_for(self):
		...
		procedure main(); var x:integer; begin x:=foo(); foo(); end"""
		expect = str(TypeMismatchInStatement(For(Id("a"),BinaryOp("+",IntLiteral(1),FloatLiteral(1.5)),UnaryOp("-",IntLiteral(2)),True,[])))
	...
	def test_40_for(self):
		...
		procedure main(); var x:integer; begin x:=foo(); foo(); end"""
		expect = str(TypeMismatchInStatement(For(Id("a"),BooleanLiteral(False),IntLiteral(1),True,[])))
	...
	def test_52_parameter_in_function(self):
		...
		procedure main(); var x:array[1 .. 3]of real;
		begin x[1]:=y:=f(x); with y:real;y:real; do begin end end"""
		expect = str(TypeMismatchInExpression(CallExpr(Id("f"),[Id("x")])))
	...
	def test_53_expressions(self):
		...
		begin x:=-1+2*3/4; end"""
		expect = str(TypeMismatchInStatement(Assign(Id("x"),BinaryOp("+",UnaryOp("-",IntLiteral(1)),BinaryOp("/",BinaryOp("*",IntLiteral(2),IntLiteral(3)),IntLiteral(4))))))
	...
	def test_54_expressions(self):
		...
		input = """procedure main(); var x:integer;
		begin x:=-1+2*3; y(); end"""
		expect = str(Undeclared(Procedure(),"y"))
	...
	def test_56_expressions(self):
		...
		input = """procedure main(); var x:integer;
		begin x:=2*3.0; end"""
		expect = str(TypeMismatchInStatement(Assign(Id("x"),BinaryOp("*",IntLiteral(2),FloatLiteral(3.0)))))
	...
	def test_59_expressions(self):
		...
		input = """procedure main(); var x:integer;
		begin x:=-1.0; end"""
		expect = str(TypeMismatchInStatement(Assign(Id("x"),UnaryOp("-",FloatLiteral(1.0)))))
	...
	def test_61_expressions(self):
		...
		input = """procedure main(); var x:integer;
		begin x:=7. moD 3; end"""
		expect = str(TypeMismatchInExpression(BinaryOp("moD",FloatLiteral(7.0),IntLiteral(3))))
	...
	def test_64_string_type(self):
		"""String cannot be used in Assign"""
		input = """procedure main(); var x:string;
		begin x:="error"; end"""
		expect = str(TypeMismatchInStatement(Assign(Id("x"),StringLiteral("error"))))
	...
	def test_66_function_not_return(self):
		...
		expect = str(FunctionNotReturn("fu"))
	...
	def test_70_function_not_return(self):
		...
		expect = str(FunctionNotReturn("fuuu"))
	...
	def test_80_index_expr(self):
		...
		begin a:=x[1.]; end"""
		expect = str(TypeMismatchInExpression(ArrayCell(Id("x"),FloatLiteral(1.0))))
	...
	def test_81_index_expr(self):
		...
		expect = str(TypeMismatchInExpression(ArrayCell(Id("x"),CallExpr(Id("sq"),[IntLiteral(2)]))))
	...
	def test_82_index_expr(self):
		...
		expect = str(Undeclared(Procedure(),"fuc"))
	...
	def test_90_builtin(self):
		...
		expect = str(TypeMismatchInStatement(Assign(Id("i"),CallExpr(Id("getFloat"),[]))))
	...
	def test_93_builtin(self):
		"""String as Parameter is OK"""
		input = """procedure main(); begin putstring("1234"); foo(); end"""
		expect = str(Undeclared(Procedure(),"foo"))
	...
	def test_94_misc(self):
		...
		procedure main();
		begin a := foo1 + 1; end"""
		expect = str(Undeclared(Identifier(),"foo1"))
	...
	def test_96_string(self):
		"""String can be used in Return and Parameter"""
		input = """procedure main(); begin putString(foo()); foo(); end
		function foo():string;
		begin return "return can be a string"; end"""
		expect = str(Undeclared(Procedure(),"foo"))
		self.assertTrue(TestChecker.test(input,expect,496))

	def test_97_expr_raise_error(self):
		"""A test from BKeL"""
		input = """procedure main (); var a:integer; begin
			a:= a := (1+1+1+1.0) + (1 or 1);
		end"""
		expect = str(TypeMismatchInExpression(BinaryOp("or",IntLiteral(1),IntLiteral(1))))
